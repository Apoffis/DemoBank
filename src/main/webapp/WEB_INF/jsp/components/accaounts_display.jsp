...
<!-- Container : Total Accounts Balance Dispay -->
<div class="container d-flex py-3">
    <h2 class="me-auto">Total Accounts Balance: </h2>
    <h2 class="ms-auto">
        <c:if test="${requestScope.totalBalance != null}">
            <c:out value="${requestScope.totalBalance}"/>
        </c:if>
    </h2>
</div>
<!-- End Of Container : Total Accounts Balance Dispay -->

<!-- Container: Accardion Menu / Drop Down -->
<div class="container">
...
<!-- End Of Container: Accardion Menu / Drop Down -->