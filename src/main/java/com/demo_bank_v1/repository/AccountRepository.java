...
public interface AccountRepository extends CrudRepository<Account, Integer> {
    ...
    Double getAccountBalance(@Param("user_id") Integer user_id, @Param("account_id") Integer account_id);

    @Modifying
    @Query(value = "UPDATE accounts SET balance = :balance WHERE account_id = :account_id", nativeQuery = true)
    @Transactional
    void changeAccountBalance(@Param("balance") Double balance, @Param("account_id") Integer account_id);
    ...
    @Transactional
    void createBankAccount(@Param("user_id") Integer user_id,
